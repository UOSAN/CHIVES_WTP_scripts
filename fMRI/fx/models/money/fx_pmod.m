%-----------------------------------------------------------------------
% Job saved on 11-Jul-2019 14:08:02 by cfg_util (rev $Rev: 6942 $)
% spm SPM - SPM12 (7219)
...
matlabbatch{3}.spm.stats.fmri_spec.dir = {'/projects/sanlab/shared/CHIVES/nonbids_data/fMRI/fx/models/money/pmod/sub-CHIVES1001'};
...
matlabbatch{3}.spm.stats.fmri_spec.sess.multi = {'/projects/sanlab/shared/CHIVES/CHIVES_timelag_scripts/fMRI/fx/multiconds/money/pmod/CHIVES1001_WTP.mat'};
matlabbatch{3}.spm.stats.fmri_spec.sess.regress = struct('name', {}, 'val', {});
matlabbatch{3}.spm.stats.fmri_spec.sess.multi_reg = {'/projects/sanlab/shared/CHIVES/CHIVES_timelag_scripts/fMRI/fx/motion/auto-motion-fmriprep/rp_txt/rp_CHIVES1001_1_money_1.txt'};
