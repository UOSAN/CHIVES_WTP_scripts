...
#SBATCH --output=TTestHeiX2Cond_afnifx.log
module load afni
...
echo --------------------------------
3dttest++                \
-prefix /projects/sanlab/shared/CHIVES/nonbids_data/fMRI/rx/money/afni_rx/TTestHeiX2Cond_afnifx    	\
-setA 	HvU_Conds \
...
-ETAC \
-prefix_clustsim TTestHeiX2Cond_ETAC_afnifx
#
echo --------------------------------
echo "ended at:"
date
